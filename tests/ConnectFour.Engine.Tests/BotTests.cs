...
public class BotTests
{
    ...
    {
        // Symmetric position so multiple columns score equally, exercising RNG tie-break.
        ...
        picks.Count.Should().BeGreaterThan(1, "tie-break should produce different columns under different seeded RNGs");
    }
}
